...
| PROJ-6 | Follow-up Dashboard & Tagesansicht (inkl. Anlässe/Geburtstage, AI-Nachrichtenvorschlag, editierbarer Draft + Ton-Anpassung, Copy-Button, Kalender-Link, 14-Tage-Vorschau, Import-Events) | In Review | [Spec](PROJ-6-follow-up-dashboard.md) | 2026-06-19 | PROJ-3, PROJ-5, PROJ-10 |
| PROJ-7 | Foto-Upload | Obsolet (ersetzt durch PROJ-20) | - | 2026-06-19 | PROJ-3 |
...
| PROJ-16 | Eigenes Profil (CV) + CV-Upload mit KI-Parsing + Auto-Bio + Career Goals | Deployed | [Spec](PROJ-16-eigenes-profil-cv.md) | 2026-06-30 | PROJ-3, PROJ-15 |
| PROJ-17 | Gemeinsamkeiten-Feld bei Kontakten (KI-Matching Profil ↔ Kontakt) | Deployed | [Spec](PROJ-17-gemeinsamkeiten-feld.md) | 2026-06-30 | PROJ-16, PROJ-3, PROJ-11 |
...
| PROJ-20 | LinkedIn Foto-Enrichment (auto Profilbild-Scraping via Apify: CSV-Import + Monats-Cron) | Deployed | [Spec](PROJ-20-linkedin-foto-enrichment.md) | 2026-07-01 | PROJ-10, PROJ-3, PROJ-1 |
